...
echo_and_run cd "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/src/simple_grasping_action"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/build/simple_grasping_action" \
    install \
    $DESTDIR_ARG \
