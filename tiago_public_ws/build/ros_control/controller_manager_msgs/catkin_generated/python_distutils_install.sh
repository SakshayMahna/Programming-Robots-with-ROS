...
echo_and_run cd "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/src/ros_control/controller_manager_msgs"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/build/ros_control/controller_manager_msgs" \
    install \
    $DESTDIR_ARG \
