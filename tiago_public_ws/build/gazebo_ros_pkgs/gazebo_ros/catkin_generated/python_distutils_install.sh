...
echo_and_run cd "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/src/gazebo_ros_pkgs/gazebo_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/media/root/BuntuDrive/Programming-Robots-with-ROS/tiago_public_ws/build/gazebo_ros_pkgs/gazebo_ros" \
    install \
    $DESTDIR_ARG \
